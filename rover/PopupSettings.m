...
-(void)createMenu
{
    ...
    CCSprite *back1 = [CCSprite spriteWithFile:@"back1.png"];
    CCSprite *back2 = [CCSprite spriteWithFile:@"back2.png"];
    ...
    CCMenuItemSprite *backBtn = [CCMenuItemSprite itemWithNormalSprite:back1 selectedSprite:back2 target:[self popupDelegate] selector:@selector(showPreviousMenu)];
    ...
    if (IS_RETINA)
    {
        menu = [CCMenu menuWithItems:musicVolumeBG, sfxVolumeBG, controlSwitchBG, retinaSwitch, backBtn, nil];
    ...
    {
        menu = [CCMenu menuWithItems:musicVolumeBG, sfxVolumeBG, controlSwitchBG, backBtn, nil];
