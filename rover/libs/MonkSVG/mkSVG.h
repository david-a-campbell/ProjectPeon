...
namespace MonkSVG {
	...
	public:
        ...
        virtual void onPathEllipse(float cx, float cy, float width, float height) {}
	...
	private:
		...
		void handle_circle( TiXmlElement* pathElement );
		void handle_ellipse( TiXmlElement* pathElement );
