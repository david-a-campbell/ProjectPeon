...
namespace MonkSVG {
	...
	,   _has_transparent_colors( false )
	{
        ...
        //    _root_transform.setTranslate(0, 768);
	...
	void OpenVG_SVGHandler::draw() {
        ...
        //		Transform2d flip;
        //		flip.setScale( 1, -1 );
        //        flip.setTranslate(0, 768);
        //		pushTransform( flip );
        //        //center the svg
        //        Transform2d center;
        //        center.setTranslate((1024-_width)/2.0f, (768-_height)/2.0f);
    ...
    void OpenVG_SVGHandler::onPathEllipse(float cx, float cy, float width, float height)
    {
        vguEllipse(_current_group->current_path->path, cx, cy, width, height);
    }
